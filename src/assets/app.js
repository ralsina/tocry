...
async function initializeAuthStatus() {
    ...
    if (!userStatusContainer || !userMenuBtn || !userMenuDropdown || !userNameDropdownElement) return;
    ...
    try {
        ...
        if (userData.logged_in) {
            ...
            document.addEventListener('click', (e) => {
                if (userMenuDropdown.style.display === 'block' && !userStatusContainer.contains(e.target)) {
