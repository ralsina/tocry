...
describe ToCry::Lane do
  describe "JSON Serialization" do
    ...
    it "serializes and deserializes a lane with one note" do
      ...
      deserialized_note.sepia_id.should eq(original_note.sepia_id)
    ...
    it "serializes and deserializes a lane with multiple notes" do
      ...
      # Compare note 1
      deserialized_lane.notes[0].sepia_id.should eq(original_lane.notes[0].sepia_id)
      ...
      # Compare note 2
      deserialized_lane.notes[1].sepia_id.should eq(original_lane.notes[1].sepia_id)
    ...
    it "produces JSON with expected structure for a lane with one note" do
      ...
      note_json["sepia_id"].as_s.should eq(note1.sepia_id)
  ...
  describe "File Persistence" do
    ...
    it "saves a lane and can be loaded back (round-trip)" do
      ...
      loaded_note1.sepia_id.should eq(note2.sepia_id)
      ...
      loaded_note2.sepia_id.should eq(note1.sepia_id)
