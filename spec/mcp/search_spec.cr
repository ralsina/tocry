  ...
  describe "Search Workflow Tests" do
    it "handles complex search scenarios" do
      ...
      begin
        ...
        high_result = tool.invoke_with_user(high_priority_params, MCPTestHelpers::TEST_USER_ID)
        ...
        learning_result = tool.invoke_with_user(learning_params, MCPTestHelpers::TEST_USER_ID)
        ...
        work_result = tool.invoke_with_user(work_params, MCPTestHelpers::TEST_USER_ID)
        ...
        limited_result = tool.invoke_with_user(limited_params, MCPTestHelpers::TEST_USER_ID)
