  ...
  describe "Note Lifecycle Workflow" do
    it "handles complete note lifecycle" do
      ...
      begin
        ...
        get_result = get_tool.invoke_with_user(get_params, MCPTestHelpers::TEST_USER_ID)
        MCPTestHelpers.assert_success_response(get_result)
        get_result["lane_name"].as_s.should eq("Todo")
        get_result["priority"].as_s.should eq("medium")
        ...
        updated_get_result["lane_name"].as_s.should eq("In Progress")
        updated_get_result["priority"].as_s.should eq("high")
        updated_get_result["title"].as_s.should contain("In Progress")
        ...
        done_get_result["lane_name"].as_s.should eq("Done")
